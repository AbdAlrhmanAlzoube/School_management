...
<body>
    ...
    <div class="body-wrapper">
        ...
        <!-- partial:partials/_sidebar.html -->
          ...
          @include('Dashboard.schoolmentors.layouts.sidebar')

    
        <!-- partial -->
        <div class="main-wrapper mdc-drawer-app-content">
          <!-- partial:partials/_navbar.html -->
          @include('Dashboard.schoolmentors.layouts.navbar')
       
            @yield('schoolmentors_content')
    ...
    <!-- Footer Section -->
    @include('Dashboard.schoolmentors.Layouts.footer')
